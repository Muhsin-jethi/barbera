...
const HeroBanner = () => {
  return (
    <Flex height='90vh' justifyContent='space-between' alignItems='center'>
          <Box fontWeight='400' color='#fff' paddingLeft='60px'>
               <Text mb='10px' fontSize='16px' color='#FBB034'>Welcome To Barbera</Text>
               <Heading fontWeight='700' lineHeight='46px' fontSize='48px'>We Will Give You An Impeccable Look</Heading>
               ...
               <Button fontWeight='700' mt='20px' color='#202125' padding='5px 20px' fontSize='15px' bg='#FBB034'>Book An Appointment</Button>
          </Box>
